    ...
    module ProviderController
      def self.included(controller)
        controller.class_eval do
          before_filter :login_required, only: %i[authorize revoke]
          ...
          skip_before_filter :verify_authenticity_token, only: %i[request_token access_token invalidate test_request token]
        end
      end
